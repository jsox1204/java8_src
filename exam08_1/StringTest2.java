...
public class StringTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("7. 부분열:" + s.substring(1)); // index 3부터 끝까지
		System.out.println("7. 부분열:" + s.substring(1, 4)); // index 1 ~ 3까지
		...
		System.out.println("14. 문자열로 변환:" + String.valueOf(10));
		System.out.println("14. 문자열로 변환:" + String.valueOf(3.14));
		System.out.println("14. 문자열로 변환:" + String.valueOf(new char[] {'A', 'B'}));
		
		// 원본 문자열 ==> String 문자열은 변경되지 않는다. 새로운 문자열을 생성한다.
